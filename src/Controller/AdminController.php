...
class AdminController extends AbstractController
{
    ...
    public function salva(Request $request)
    {
        ...
        $aux = new Accion();
        $nombre = "database-".$bd.$aux->DateTimeToString($fecha).".sql";
        $fullName = "uploads/database/".$nombre;
        ...
        */
        $tablas = false;
        //$tablas = array("accion","objetivo","objetivo_entidad","entidad", "log", "migration_versions", "tipo_accion", "user");
