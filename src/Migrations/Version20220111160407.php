 ...
 */
final class Version20220111160407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D6496CA204EF ON user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8D93D6496CA204EF ON user (entidad_id)');
    }
}
